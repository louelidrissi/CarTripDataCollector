...
final class LocationManager: NSObject, CLLocationManagerDelegate {
    ...
    private var isUpdating = false // use to protect against duplicates
    ...
    func requestPermission() {
        ...
        case .denied, .restricted:
            ...
            break
        default:
            break //startUpdatingLocation()
        }
    }
    
    // method 2
    func startUpdatingLocation() {
       // guard CLLocationManager.locationServicesEnabled() else { return }, already taken care of in did Change Auth
